...
welcome = ttk.Label(frame1, text = "Welcome to the Option Calculator! This application has been developed to compute the theoretical price of an option\
 derivatives \nusing two different models. Before using it make sure to use the dot notation for numbers and specify the maturity in terms\
 \nof years (i.e. 0.5 = 6 months and 1/365 = 1 day). Moreover, the application has been made such that the Black-Scholes model is allowed \nonly\
...
calc = ttk.Button(frame3, text = "CALCULATE",command = OptionPricing, height = 1, width = 15, fg = "green", bg = "#bded9b", font = ('Helvetica', 10, 'bold')).grid(row = 0, column = 0, padx = 130, pady = 26)
reset = ttk.Button(frame3, text = "RESET", command = cancel, height = 1, width = 15, fg = "red", bg = "#ff8989", font = ('Helvetica', 10, 'bold')).grid(row = 1, column = 0, pady = 26)
...
delta_l_bin = ttk.Label(frame4, text = "Delta", font = ('Helvetica', 8, 'bold')).grid(row = 1, column = 2, sticky = "W")
rho_l_bin = ttk.Label(frame4, text = "Rho", font = ('Helvetica', 8, 'bold')).grid(row = 2, column = 0, sticky = "W", pady = 5)
gamma_l_bin = ttk.Label(frame4, text = "Gamma", font = ('Helvetica', 8, 'bold')).grid(row = 2, column = 2, sticky = "W", pady = 5)
theta_l_bin = ttk.Label(frame4, text = "Theta", font = ('Helvetica', 8, 'bold')).grid(row = 3, column = 0, sticky = "W")
vega_l_bin = ttk.Label(frame4, text = "Vega", font = ('Helvetica', 8, 'bold')).grid(row = 3, column = 2, sticky = "W", pady = 5)
